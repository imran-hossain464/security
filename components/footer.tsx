        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/dashboard/help" className="text-gray-400 hover:text-white transition-colors">
                  Help Network
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/dashboard/forum" className="text-gray-400 hover:text-white transition-colors">
                  Community Forum
                </Link>
              </li>
              <li>
                <Link href="/dashboard/messages" className="text-gray-400 hover:text-white transition-colors">
                  Messages
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/dashboard/help-support" className="text-gray-400 hover:text-white transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
